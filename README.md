...
- [Конвертер автоматов и регулярок с порождением пошагового описания преобразований в latex (А.Дельман, Д.Князихин, А.Терентьева, К.Шевченко и др.) ACHTUNG! в main логируется не всё](https://github.com/StarikTenger/Chipollino)
