...
Материалы курса теория формальных языков для ИУ9 2022 года.
...
P.S. - Поторопились фармить-то ;) Нужно было фильтровать по `__eq`, а не по обратному вложению, и текущее множество, а не бэкап. Ну и конструкция подмножеств рулит, а без неё пока false positives есть ещё. Поэтому только +3, а можно было бы и больше.
