# Какие воспоминания обновить, чтобы лучше понимать лекцию 19 сентября

1. Из ДМ - алгоритмы Тарьяна и Косарайю для нахождения компонент сильной связности графа 

Из алгебры:

2. Смежные классы
3. Теорема Лагранжа
4. (возможно, успеем использовать, возможно нет) Первая теорема о гомоморфизме групп
   
# Важно!

В материалах 2021-2023 годов лекции организованы не в соответствии плану обновлённой версии 2024 года, версия 2026 года отличается от всех предыдущих по набору и структуре материала, но перекрывается в отдельных темах, так что заглядывать в старые лекции всё равно полезно. 
