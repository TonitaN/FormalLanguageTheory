# Какие воспоминания обновить, чтобы лучше понимать лекцию 12 сентября
...
3. (постфактум к лекции 1) свободные группы, копредставления (ака представления посредством определяющих соотношений). И можно освежить (или решить заново) Пример 1.78 из лекций ГН - показать, что из этих соотношений следует коммутативность любых элементов (это задачка не столько по алгебре, сколько по ТФЯ).
