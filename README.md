...
- [ординальный калькулятор (есть баги из-за неправильной подстановки параметров предела! в частности, ординал $2^(w\cdot 2)$ нормализуется не в $w^2$, а в $w\cdot 2$)](https://www.mtnmath.com/ord/)
